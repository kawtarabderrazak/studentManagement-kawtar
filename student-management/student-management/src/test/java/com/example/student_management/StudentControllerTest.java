...
class StudentControllerTest {
    ...
    void testSaveStudent() {
        ...
        assertEquals("Yido", response.getBody().getNom());
    }
    ...
    void testFindAllStudents() {
        ...
        // Simuler la récupération de tous les étudiants
    ...
    void testFindByYear() {
        ...
        ResponseEntity<List<Student>> response = studentController.findByYear();
